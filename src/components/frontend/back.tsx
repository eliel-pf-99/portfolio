...
export default function FrontCanv(){
    ...
    useEffect(() => {
        ...
        class Circle{
                ...
                draw(){
                    context.beginPath();
                    context.arc(this.x , this.y , this.radius, this.EndAngle - this.position, this.StartAngle - this.position, false )
                    context.stroke();
                    context.closePath();
                }
    ...
    return <canvas ref={canvasRef} className=" z-0  absolute h-full w-full top-0"></canvas>
